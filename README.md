...
<p align="center">
  <a href="https://devtools.at/tools/htaccess-generator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Generate Apache .htaccess rules</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/htaccess-generator">Try Online</a> •
...
**[Try .htaccess Generator online at DevTools.at →](https://devtools.at/tools/htaccess-generator)**
...
Generate Apache .htaccess rules. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/htaccess-generator';
